...
<body class="font-sans antialiased bg-gray-50 text-gray-900">
    ...
    <div class=" px-4 sm:px-6 lg:px-8 py-10 space-y-14">
        ...
        <section>
            ...
            <div class="flex flex-col lg:flex-row gap-x-12 gap-y-10 items-start">
                ...
                <div class="flex flex-col flex-1 gap-10">
                    ...
                    <div class="flex flex-col">
                        ...
                        <button
                            class="toggle-table-height-btn mt-2 h-8 w-8 flex items-center justify-center text-black text-xs font-semibold border border-emerald-200 bg-emerald-100 hover:bg-emerald-200 hover:shadow-md rounded-sm transition-all duration-200 focus:outline-none">
                            ▼
                        </button>
                    </div>
