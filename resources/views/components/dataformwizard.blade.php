            ...
            <div class="grid lg:grid-cols-[300px_1fr]">
                ...
                <div class="flex flex-col overflow-y-auto max-h-screen p-6 lg:p-10">
                    <form @submit.prevent="handleSubmit" class="flex flex-1 flex-col">
                        <div class="flex-1">
                            <!-- Householder Information Form (First Section) -->
                            <div x-show="currentStep === 1" x-transition:enter="transition ease-out duration-300"
                                ...
                                <div class="grid gap-6 grid-cols-1 md:grid-cols-2">
                                    ...
                                    <div
                                        ...
                                        <p x-show="householderErrors.householder_name"
                                    ...
                                    <div
                                        ...
                                        <input type="text" x-model="formData.householder.father_name"
                                            @input="clearHouseholderError('father_name')" required
                                            class="input-field mt-4 block w-full rounded-lg border border-gray-300 px-4 py-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                            placeholder="बुबाको नाम राख्नुहोस्">
                                        <p x-show="householderErrors.father_name"
                                            class="mt-2 text-sm text-red-600 error-message"
                                    ...
                                    <div
                                        ...
                                        <input type="text" x-model="formData.householder.mother_name"
                                            @input="clearHouseholderError('mother_name')" required
                                            class="input-field mt-4 block w-full rounded-lg border border-gray-300 px-4 py-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                            placeholder="आमाको नाम राख्नुहोस्">
                                        <p x-show="householderErrors.mother_name"
                                            class="mt-2 text-sm text-red-600 error-message"
                                    ...
                                    <div
                                        ...
                                        <select x-model="formData.householder.mother_tongue_id"
                                            @change="clearHouseholderError('mother_tongue_id')" required
                                            class="input-field mt-4 block w-full rounded-lg border border-gray-300 px-4 py-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                        ...
                                        <p x-show="householderErrors.mother_tongue_id"
                                            class="mt-2 text-sm text-red-600 error-message"
                                    ...
                                    <div
                                        ...
                                        <select x-model="formData.householder.caste_id"
                                            @change="clearHouseholderError('caste_id')" required
                                            class="input-field mt-4 block w-full rounded-lg border border-gray-300 px-4 py-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                        ...
                                        <p x-show="householderErrors.caste_id"
                                            class="mt-2 text-sm text-red-600 error-message"
                                    ...
                                    <div
                                        ...
                                        <select x-model="formData.householder.tole_id"
                                            @change="clearHouseholderError('tole_id')" required
                                            class="input-field mt-4 block w-full rounded-lg border border-gray-300 px-4 py-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                        ...
                                        <p x-show="householderErrors.tole_id"
                                            class="mt-2 text-sm text-red-600 error-message"
                                    ...
                                    <div
                                        ...
                                        <input type="number" x-model.number="formData.householder.ward_no"
                                            @input="clearHouseholderError('ward_no')" required
                                            class="input-field mt-4 block w-full rounded-lg border border-gray-300 px-4 py-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                            placeholder="Enter ward number">
                                        <p x-show="householderErrors.ward_no"
                                            class="mt-2 text-sm text-red-600 error-message"
                                    ...
                                    <div
                                        ...
                                        <input type="text" x-model="formData.householder.house_number"
                                            @input="clearHouseholderError('house_number')" required
                                            class="input-field mt-4 block w-full rounded-lg border border-gray-300 px-4 py-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                            placeholder="घर नं राख्नुहोस्">
                                        <p x-show="householderErrors.house_number"
                                            class="mt-2 text-sm text-red-600 error-message"
                                    ...
                                    <div
                                        ...
                                        <input type="tel" x-model="formData.householder.phone_number"
                                            @input="clearHouseholderError('phone_number')" required maxlength="10"
                                            pattern="[0-9]{10}"
                                            class="input-field mt-4 block w-full rounded-lg border border-gray-300 px-4 py-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                            placeholder="फोन नं राख्नुहोस्">
                                        <p x-show="householderErrors.phone_number"
                                            class="mt-2 text-sm text-red-600 error-message"
                                    ...
                                    <div
                                        ...
                                        <textarea x-model="formData.householder.citizenship_permanent_address"
                                            @input="clearHouseholderError('citizenship_permanent_address')" required rows="3"
                                            class="input-field mt-4 block w-full rounded-lg border border-gray-300 px-4 py-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                            placeholder="नागरिकता स्थायी ठेगाना राख्नुहोस्"></textarea>
                                        <p x-show="householderErrors.citizenship_permanent_address"
                                            class="mt-2 text-sm text-red-600 error-message"
                                            x-text="householderErrors.citizenship_permanent_address"></p>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="file-upload-area mt-4 rounded-lg p-6 text-center"
                                            ...
                                            <div x-show="formData.householder.profile_photo" class="mt-4">
                                                <div class="flex items-center justify-center gap-2">
                                                    <img :src="formData.householder.profile_photo_preview"
                                                        alt="Profile preview"
                                                        class="h-20 w-20 rounded-lg object-cover">
                                                    <button type="button" @click="removeHouseholderPhoto()"
                                        ...
                                        <p x-show="householderErrors.profile_photo"
                                            class="mt-2 text-sm text-red-600 error-message"
        ...
        function surveyWizard() {
            return {
                ...
                validateHouseholderStep() {
                    ...
                    if (!h.citizenship_permanent_address || h.citizenship_permanent_address.trim() === '') {
                        this.householderErrors.citizenship_permanent_address = 'Citizenship permanent address is required';
                        isValid = false;
                    }
                ...
                async handleSubmit() {
                    ...
                    try {
                        ...
                        formData.append('citizenship_permanent_address', h.citizenship_permanent_address);
