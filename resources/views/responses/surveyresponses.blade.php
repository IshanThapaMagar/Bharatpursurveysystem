                ...
                <div class="overflow-x-auto">
                    <table id="responses-table" class="min-w-full divide-y divide-gray-200 table-auto text-sm">
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">ऋ.स</th>
                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">घरमुलीको नाम</th>
                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">घर नं</th>
                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">टोल</th>
                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">फोन नं</th>
                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">कित्ता नं</th>
                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">फोटो</th>
                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">सदस्य संख्या</th>
                                {{-- Hidden column: ward_no for filtering --}}
                                <th class="hidden">वडा</th>
                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">कार्यहरू</th>
                            </tr>
                        </thead>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td data-label="फोटो" class="px-4 py-3">
                                        @if ($response->householder?->profile_photo)
                                            <img src="{{ asset('storage/' . $response->householder->profile_photo) }}"
