...
{
    /**
     * Only non-DataCollectors may update surveys.
     * Ward-ownership is re-checked in SurveyBuilderService.
     */
    ...
    /**
     * Decode and merge the JSON payload identically to StoreSurveyRequest
     * so we can apply nested rules without touching the controller.
     */
